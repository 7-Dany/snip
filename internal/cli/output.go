...
// PrintLogo displays the application logo with a magical unicorn
func PrintLogo() {
...
// ClearScreen clear everything on screen
func ClearScreen() {
...
func PrintHelp(topic string) {
	...
	switch topic {
	case "":
		printGeneralHelp(cyan, white, gray)
	case "snippet":
		printSnippetHelp(cyan, white, gray)
	case "category":
		printCategoryHelp(cyan, white, gray)
	case "tag":
		printTagHelp(cyan, white, gray)
	default:
...
func printGeneralHelp(cyan, white, gray *color.Color) {
	cyan.Println("\nUSAGE")
...
func printSnippetHelp(cyan, white, gray *color.Color) {
	cyan.Println("\nSNIPPET COMMANDS")
...
func printCategoryHelp(cyan, white, gray *color.Color) {
	cyan.Println("\nCATEGORY COMMANDS")

	white.Println("\n  category create")
	fmt.Println("    Create a new category for organizing snippets.")
	gray.Println("    Usage: snip category create")
...
func printTagHelp(cyan, white, gray *color.Color) {
	cyan.Println("\nTAG COMMANDS")
