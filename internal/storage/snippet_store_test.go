...
func setupTestSnippetStore() *Store {
...
func TestSnippetStoreList(t *testing.T) {
	...
	t.Run("returns multiple snippets", func(t *testing.T) {
		store := setupTestSnippetStore()
		ss := newSnippetStore(store)
...
func TestSnippetStoreFindByID(t *testing.T) {
...
func TestSnippetStoreFindByCategory(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		store := setupTestSnippetStore()
		ss := newSnippetStore(store)
...
func TestSnippetStoreFindByTag(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		store := setupTestSnippetStore()
		ss := newSnippetStore(store)
...
func TestSnippetStoreFindByLanguage(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		store := setupTestSnippetStore()
		ss := newSnippetStore(store)
...
func TestSnippetStoreSearch(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		store := setupTestSnippetStore()
		ss := newSnippetStore(store)
...
func TestSnippetStoreCreate(t *testing.T) {
	...
	t.Run("updates search index", func(t *testing.T) {
		store := setupTestSnippetStore()
		ss := newSnippetStore(store)
...
func TestSnippetStoreUpdate(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		store := setupTestSnippetStore()
		ss := newSnippetStore(store)
	...
	t.Run("reindexes search", func(t *testing.T) {
		store := setupTestSnippetStore()
		ss := newSnippetStore(store)
...
func TestSnippetStoreDelete(t *testing.T) {
	...
	t.Run("removes from search index", func(t *testing.T) {
		store := setupTestSnippetStore()
		ss := newSnippetStore(store)
